...
@section("main")
    <div class="d-md-flex align-items-center justify-content-between mb-5">
        <h1 class="mb-0">{{ $tombola->libelle}}</h1>
        <div class="text-end mt-4 mt-md-0"><a target="_blank" class="btn btn-outline-primary" href="{{ route('tombola-site', $tombola->id) }}"><i class="fas fa-eye"></i> Voir le site</a></div>
    </div>
                                ...
                                <table id="tableauRevision" class="display table table-striped table-hover" cellspacing="0" width="100%">
                                    ...
                                    @foreach($tombola->achat as $achat)
                                        <tr>
                                            ...
                                            <td>{{ $achat->user->name . " " . $achat->user->first_name }}</td>
                                            <td>{{ $achat->ticket }}</td>
                    ...
                    <div class="card g-4">
                        ...
                        <div class="card-body">
                            @foreach($tombola->lot as $lot)
                                <div class='card'>
                                    <img src="{{asset('assets/img/lot/'. $lot->tombola_id . '/'. $lot->image)}}" class='card-img-top' alt='{{ $lot->libelle}}'>
                                    <div class="card-body">
                                    ...
                                    <div class="RegisterOrganism--Name HaFormField">
                                        <div class="row g-3 align-items-center" style="margin-bottom:20px;">
                                            ...
                                            <div>
                                                <div class="HaFormField--Field">
                                                    <div class="Input--Wrapper Input--Wrapper-Medium">
                                                        <input type="email"  required style="border-radius: 3px!important;border: 2px solid #00909e !important;" data-max="3" id="don-tombola-buy" maxlength="100"
