							...
							@if(count($tombolas) > 0)
								@foreach($tombolas as $tombola) 
									<tr data-canceled="false" data-finished="false" href="#"
										...
										<td style="font-size:14px;" class="mantine-1h4e3s6" >{{ toApiGetway("association", "getName",["id" => $tombola['association_id']])["data"] }}</td>
								...
								@if(isset($bingos) && $bingos != null && count($bingos) > 0)
									@foreach($bingos as $bingo) 
										<tr data-canceled="false" data-finished="false" href="#"
											...
											<td style="font-size:14px;" class="mantine-1h4e3s6" >{{ toApiGetway("association", "getName",["id" => $bingo["association_id"]])["data"] }}</td>
