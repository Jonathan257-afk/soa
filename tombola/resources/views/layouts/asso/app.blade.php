                ...
                <div class="pro-sidebar hide-menu aside-menu-container" id="container-slidbar">
                    <div class="pro-sidebar-inner">
                        <div class="pro-sidebar-layout pro-active-sub">
                            <div class="pro-sidebar-header aside-menu-container__aside-logo flex-column-auto pb-2 pt-3"><a href="{{ route('asso-dashboard') }}"
                                ...
                                </a><button id="btn-collapse-slidbar-desktop" type="button"
                                ...
                                <div class="d-flex align-items-stretch justify-content-center">
                                    <div class="align-items-stretch justify-content-between flex-row navbar-nav">
                                        <ul class="nav align-items-center">
                                            <li><a class="px-sm-3 px-2 d-flex text-decoration-none">{{ auth()->user()->name }}</a></li>
                                        </ul>
                                        <div class="d-flex align-items-stretch dropdown">
                                            <button type="button" id="dropdown-basic"
                                                aria-expanded="false"
                                                class="hide-arrow bg-transparent border-0 p-0 d-flex align-items-center dropdown-toggle">
                                                <div class="d-flex align-items-center justify-content-center">
                                                    <img
                                                        src="{{asset('assets/img/logo/'. auth()->user()->association->id . '/' . auth()->user()->association->logo)}}"
                                                        alt="user-avatar" height="50" width="50"
                                                        class="image image-circle image-tiny">
                                                </div>
                                            </button>
                                        </div>
                                    </div>
