...
@section("main")
    <div class="d-md-flex align-items-center justify-content-between mb-5">
        <h1 class="mb-0">Ajout d'un nouveau Bingo</h1>
        <div class="text-end mt-4 mt-md-0"><a class="btn btn-outline-primary" href="{{ route('asso-bingo-index') }}"><svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="arrow-left" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="svg-inline--fa fa-arrow-left">
    ...
    <form method="post" id="form-add-bingo" action="{{ route('asso-bingo-store') }}"  enctype="multipart/form-data">
        @csrf
        <div class="card">
            <div class="pb-0 px-10 card-header">
                <h5 class="mb-0">Information sur le Bingo</h5>
            ...
            <div class="card-body">
                <div class="row">
                            ...
                            <div class=" css-b62m3t-container"><span id="react-select-7-live-region"
                                ...
                                <div class=" css-1s2u09g-control">
                                    <div class=" css-1d8n9bt">
                                            <input class="" required type="datetime-local" name="dateDebut" id="input-add-date-debut-bingo"
                    ...
                    <div class="col-md-5">
                        <div class="form-group w-100"><label class="form-label" for="formBasic">Date de tirage ( {{ config("app.timezone_utc") }} ):</label><span
                            ...
                            <div class=" css-b62m3t-container"><span id="react-select-7-live-region"
                                ...
                                <div class=" css-1s2u09g-control">
                                    <div class=" css-1d8n9bt">
                                            <input class="" required type="datetime-local" name="date" id="input-add-date-bingo"
                                                style="color: inherit; background: 0px center; opacity: 1; width: 100%; grid-area: 1 / 2; font: inherit; min-width: 2px; border: 0px; margin: 0px; outline: 0px; padding: 0px;">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-md-5">
                        <div class="form-group w-100"><label class="form-label" for="formBasic">Nombre de ticket:</label><span
                                class="required"></span>
                            <div class=" css-b62m3t-container"><span id="react-select-7-live-region"
                                    class="css-7pg0cj-a11yText"></span><span aria-live="polite" aria-atomic="false"
                                    aria-relevant="additions text" class="css-7pg0cj-a11yText"></span>
                                <div class=" css-1s2u09g-control">
                                    <div class=" css-1d8n9bt">
                                            <select class="" required name="ticket" id="input-add-ticket-tombola"
                                                style="color: inherit; background: 0px center; opacity: 1; width: 100%; grid-area: 1 / 2; font: inherit; min-width: 2px; border: 0px; margin: 0px; outline: 0px; padding: 0px;">
        ...
        <div class="d-md-flex align-items-center justify-content-between mb-5">
        <div class="text-end mt-4 mt-md-0 mb-0"><a class="btn btn-outline-danger" href="{{ route('asso-bingo-index') }}"><svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="arrow-left" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="svg-inline--fa fa-arrow-left">
                            <path fill="currentColor" d="M257.5 445.1l-22.2 22.2c-9.4 9.4-24.6 9.4-33.9 0L7 273c-9.4-9.4-9.4-24.6 0-33.9L201.4 44.7c9.4-9.4 24.6-9.4 33.9 0l22.2 22.2c9.5 9.5 9.3 25-.4 34.3L136.6 216H424c13.3 0 24 10.7 24 24v32c0 13.3-10.7 24-24 24H136.6l120.5 114.8c9.8 9.3 10 24.8.4 34.3z" class=""></path>
                        </svg> Annuler</a></div>
...
@section("footer")
    <script>
        ...
        document.getElementById('input-add-date-bingo').min = now;
        document.getElementById('input-add-date-debut-bingo').min = now;
