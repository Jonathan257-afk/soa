...
class BingoController extends Controller
{
    ...
    public function getAllByIdAsso(Request $request) {
        $bingo = Bingo::getAllByIdAsso($request->input("id"));
        if($bingo) {
            return response()->json([
                "res" => true,
                "data" => $bingo
    ...
    public function getAllEnCoursByIdAsso(Request $request) {
        $bingo = Bingo::getAllEnCoursByIdAsso($request->input("id"));
        if($bingo) {
            return response()->json([
                "res" => true,
                "data" => $bingo
    ...
    public function store(Request $request) {
        ...
        $bingo = Bingo::store($request->input("dateDebut"), $request->input("date"), $request->input("libelle"), $request->input("montant"), $request->input("ticket"), $request->input("association_id"));
        if($bingo) {      
